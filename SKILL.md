...
from sw_2026_skill.sw_verify import verify_step
...
| 快照复核（SaveBMP+Pillow） | `sw_2026_skill/sw_snapshot.py` | `references/snapshot-review.md` |
| 选择器引用（STEP→#h1 标签） | `sw_2026_skill/sw_selector_refs.py` | `references/selector-reference-system.md` |
| step.parts 外购件集成 | `sw_2026_skill/sw_step_parts.py` | `references/step-parts-integration.md` |
